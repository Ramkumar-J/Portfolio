  ...
  return (
    <div class="container">
      ...
      <div className='row mt-2 text-white' data-aos="fade-right" data-aos-duration="600">
        ...
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/color/100/css3.png"></img>
          <h6 className='ms-4 fw-bolder'>CSS3</h6>
        </div>
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/color/100/bootstrap.png"></img>
          <h6 className='ms-4 fw-bolder'>Bootstrap</h6>
        </div>
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/color/100/javascript--v1.png"></img>
          <h6 className='ms-4 fw-bolder'>JavaScript</h6>
        </div>
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/plasticine/100/react.png"></img>
          <h6 className='ms-4 fw-bolder'>Reactjs</h6>
        </div>
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid  skill-logo' src="https://img.icons8.com/wired/100/postman-api.png"></img>
      ...
      <div className='row mt-2 text-white' data-aos="fade-right" data-aos-duration="600">
        ...
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/color/100/mysql-logo.png"></img>
          <h6 className='ms-4 fw-bolder'>MySQL</h6>
        </div>
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/100/external-mongodb-a-cross-platform-document-oriented-database-program-logo-shadow-tal-revivo.png"></img>
      ...
      <div className='row mt-2 text-white' data-aos="fade-right" data-aos-duration="600">
        ...
        <div className='col-4 col-sm-4 col-md-2 col-lg-2'>
          <img className='img-fluid skill-logo' src="https://img.icons8.com/glyph-neue/100/github.png"></img>
