    ...
    <section class="container">
      <div className='row mt-3'>
        <div className='col-lg-12'>
          <h1 className='text-center fw-bolder' data-aos="fade-up">Skills</h1>
        </div>
      </div>
      <div className='row mt-3'>
        <div className='col-lg-12'>
          <h3 className='text-center text-danger fw-bolder' data-aos="fade-up">Frontend Tools</h3>
        </div>
      </div>
...
<div className='col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 col-xxl-2 text-center'>
          <img className='img-fluid skill-logo' src={frontendTool.logo} alt="Frontend Tool Logo"></img>
      ...
      <div className='row mt-2'>
        <div className='col-lg-12'>
          <h3 className='text-center text-danger fw-bolder' data-aos="fade-up">Backend Tools</h3>
        </div>
      </div>
      <div className='row mt-2' data-aos="fade-right" data-aos-duration="600">
        {
          backendTools.map((backendTool) => {
            return(
<div className='col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 col-xxl-2 text-center'>
          <img className='img-fluid skill-logo' src={backendTool.logo} alt="Backend Tool Logo"></img>
      ...
      <div className='row mt-2'>
        <div className='col-lg-12'>
          <h3 className='text-center text-danger fw-bolder' data-aos="fade-up">Version Control Tools</h3>
        </div>
      </div>
      <div className='row mt-2' data-aos="fade-right" data-aos-duration="600">
        {
          versionTools.map((versionTool) => {
            return(
              <div className='col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 col-xxl-2 text-center'>
              <img className='img-fluid skill-logo' src={versionTool.logo} alt="Version Tool Logo"></img>
